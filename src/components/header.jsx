...
export const Header = () => {
  ...
  return (
    <header className="header">
      ...
      <ul className={`header__menu ${isMenuOpen ? "header__menu-mobile" : ""}`}>
        <Link to="/">
          <li className="header__menu__item" onClick={handleMenuItemClick}>Главная</li>
        </Link>
        <ScrollLink
          spy={true}
          smooth={true}
          ...
          to="main__taskTitle"
        >
          <li className="header__menu__item" onClick={handleMenuItemClick}>Задачи</li>
        </ScrollLink>
        <ScrollLink
          spy={true}
          smooth={true}
          ...
          to="main__titleAbout"
        >
          <li className="header__menu__item" onClick={handleMenuItemClick}>О проекте</li>
        </ScrollLink>
      </ul>
